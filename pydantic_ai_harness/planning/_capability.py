...
from pydantic_ai_harness.planning._toolset import PlanItem, PlanningToolset, PlanState, render_plan
...
class Planning(AbstractCapability[AgentDepsT]):
    ...
    def get_toolset(self) -> AgentToolset[AgentDepsT] | None:
        ...
        return PlanningToolset(self._state)
    ...
    def plan(self) -> list[PlanItem]:
        """Read-only snapshot of the current plan."""
