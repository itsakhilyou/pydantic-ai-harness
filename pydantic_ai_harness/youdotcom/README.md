...
Web search, content extraction, and research for Pydantic AI agents, powered by
[You.com APIs](https://docs.you.com/).
...
and `max_age` are never exposed to the LLM; they are always human-controlled.
