...
| | **Tool access control** | Block tools or require approval before execution | :white_check_mark: [Docs](pydantic_ai_harness/permission_policy/) | [pydantic-ai-shields](https://github.com/vstorm-co/pydantic-ai-shields) (vstorm&#8209;co) |
