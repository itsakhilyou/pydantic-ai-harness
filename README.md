...
| **Memory &&nbsp;persistence** | **Memory** | Injected MEMORY.md notebook + on-demand memory files (per-run namespacing for multi-user apps) | :white_check_mark: [Docs](pydantic_ai_harness/memory/) | [pydantic-deep](https://github.com/vstorm-co/pydantic-deepagents) (vstorm&#8209;co) |
