...
| | **LocalStack** | Emulated AWS environment with AWS CLI tools and optional Docker lifecycle | :construction: [PR&nbsp;#268](https://github.com/pydantic/pydantic-ai-harness/pull/268) / [Docs](pydantic_ai_harness/experimental/localstack/) | |
