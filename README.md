...
| | **Document conversion** | Convert PDF/DOCX/PPTX/HTML/images to Markdown via [Docling](https://github.com/docling-project/docling) | :white_check_mark: [Docs](pydantic_ai_harness/docling/) | |
| | **HTML to Markdown** | Convert HTML to Markdown via [markdownify](https://github.com/matthewwithanm/python-markdownify) | :white_check_mark: [Docs](pydantic_ai_harness/markdownify/) | |
